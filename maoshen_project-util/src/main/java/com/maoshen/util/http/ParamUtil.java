...
/**
 * <p>Title: html请求参数工具类</p>
 * <p>Description: 提供得到浏览器提交的各种类型请求参数值功能，方便操作</p>
 */
...
public class ParamUtil
{
	...
	public static String[] getArrayParameter(HttpServletRequest request,
			String paramName) {
	 ...
	 * page.
	 * @param name The name of the parameter you want to get
	 * @param emptyStringsOK Return the parameter values even if it is an empty
	 * string.
